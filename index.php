...
<body>
    ...
    <main>
        <section id="notre-expertise">
            ...
            <p>Depuis 2013, nous travaillons ensemble avec des équipes et nous mettons en pratique nos méthodes peu communes. Nulle
                part ailleurs vous ne rencontrerez un tel niveau de professionnalisme. Nous nous sommes améliorés chaque année
                pour offrir à ce jour des entraînements uniques et adaptés à toutes les situations et à tous les joueurs. Et
                nous continuerons d’évoluer et de développer nos techniques, car nous recherchons les meilleurs résultats.<br>
                <br></p>
            <h3>Notre fonctionnement</h3>
            <p>Nous nous réunissons 2 à 3 fois par semaine dans des séances organisées de 2 heures. Des séances supplémentaires
                auront lieu lors de nos participations à des tournois. Nous proposons des entraînements thématiques, des analyses
                de situations et de parties, des discussions théoriques, des échanges sur la méta, des briefings et débriefings.<br>
                <br>
                Nous sommes capables de synchroniser vos communications et vos actions lorsque nous vous observons jouer. De
                plus, nous nous aidons de plusieurs outils tels que des grilles d'analyse, des fiches de suivi (individuel et
                de l'équipe) et des documents stratégiques et de statistiques.<br>
                <br>
                Les séances sont planifiées et les contenus annoncés en amont. Nous mettons à disposition un serveur TeamSpeak
                sur lequel nous sommes dans les meilleures conditions pour communiquer et que vous avez la liberté d'utiliser
                sur votre temps.</p>
        </section>
        <section id="notre-projet">
            ...
            <ul>
                ...
                <li>Rendre accessible, aux plus motivés, un service personnalisé et adapté d’entraînement et d’accompagnement;
                </li>
        ...
        <section id="participer">
            ...
            <p>La procédure de recrutement s’organise en deux phases. La première étape consiste à répondre au formulaire de présélection.
                Si votre candidature nous intéresse, nous vous contacterons afin de convenir d’un entretien vocal. À la fin de
